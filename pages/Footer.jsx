  ...
  return (
    ...
    >
      <div className="grid grid-cols-2 lg:grid-cols-4 lg:gap-2 mx-6 my-10 py-2">
        <div className="flex flex-col  mx-6 mt-4">
          <div className="py-1" role="none">
            {' '}
            <p className="text-yellow-500  text-2lg font-semibold">
              CATEGORIES
            </p>
          </div>
        ...
        <div className="flex flex-col mx-6 mt-4">
          ...
          <div className="py-1" role="none">
            <Link legacyBehavior href="/access/signup">
              <a className="text-white block  py-2 lg:py-1 text-sm text-white hover:text-gray-300 uppercase">
                Account Signup
              </a>
            </Link>
            ...
            <Link legacyBehavior href="/access/reset">
              <a className="text-white block  py-2 lg:py-1 text-sm text-white hover:text-gray-300 uppercase">
                Password Reset
              </a>
            </Link>
        ...
        <div className="flex flex-col mx-6 mt-4">
          <div className="py-1" role="none">
            {' '}
            <p className="text-yellow-500 text-2lg font-semibold">LEGAL</p>
          </div>
          <div className="py-1" role="none">
        ...
        <div className="flex flex-col mx-6 mt-4">
          <div className="py-1" role="none">
            <div className="py-1" role="none">
              {' '}
              <p className="text-yellow-500 text-2lg font-semibold uppercase">
                Follow Us
              </p>
            </div>
            <p className="flex">
              <a href={process.env.INSTAGRAM} target="_blank">
                <FaInstagramSquare className="text-2xl text-pink-500 hover:pink-blue-400" />
              </a>
              <a href={process.env.FACEBOOK} target="_blank">
                <FaFacebookSquare className="text-2xl text-blue-500 hover:text-blue-400" />
              </a>{' '}
              <a href={process.env.TWITTER} target="_blank">
                <FaTwitterSquare className="text-2xl text-blue-300 hover:text-blue-300" />
              </a>
            </p>
          </div>
        </div>
      ...
      <div className="py-1 ml-6" role="none">
        ...
        >
          <div className="input-group flex">
            <MdOutlineEmail className="text-xl bg-white h-full py-4 pl-1 rounded-l-lg leading-7" />
            <input
              className="bg-white text-sm leading-7"
              type="email"
              name="email"
              placeholder="Your email"
            />
            <button
              className="rounded-r-lg bg-yellow-400 px-1 leading-7"
              type="submit"
              name="subscribe"
            >
              Subscribe
      ...
      <div className="bg-slate-900 border-white border-t-2 py-6 text-white flex justify-center">
        <p className="mx-auto">
          &copy; COPYRIGHT {process.env.SITENAME} 2021-
